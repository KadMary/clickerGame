...
function createTable(name,top=0)
{
    ...
    document.getElementById("map").append(table_div);
}
...
function createShopItemСount(name){
    ...
    //itemCount.setAttribute("shopCreaturesItem", name)
        ...
        if(!isSell){
            ...
            if(shopCreaturesInfo[name].count){
                ...
                if(shopCreaturesInfo[name].count == 0){
                    document.getElementById("map").removeChild(document.getElementById('peasant_table'))
                }
            }
    ...
    let hut = createShopItem('Hut','hut');
        ...
        function addCountUp(){
            if(!isSell){
                ...
                if(shopCreaturesInfo[name].count){
                    sellItem('hut');
                    if(shopCreaturesInfo[name].count == 0){document.getElementById("map").removeChild(document.getElementById('hut_table'))}
                }
...
function createWarrior(){
    ...
    function addCountUp(){
        if(!isSell){
            ...
            if(shopCreaturesInfo[name].count){
                sellItem('warrior');
                if(!shopCreaturesInfo[name].count){document.getElementById("map").removeChild(document.getElementById('warrior_table'))}
            }
        }
    }
...
function createWizard(){
    ...
    function addCountUp(){
        if(!isSell){
            ...
            if(shopCreaturesInfo[name].count){
                sellItem('wizard');
                if(!shopCreaturesInfo[name].count){document.getElementById("map").removeChild(document.getElementById('wizard_table'))}
            }
        }
    }
...
function createTower(){
    ...
    function addCountUp(){            
        if(!isSell){
            ...
            if(shopCreaturesInfo[name].count){
                sellItem('tower');
                if(!shopCreaturesInfo[name].count){document.getElementById("map").removeChild(document.getElementById('tower_table'))}
            }
        }
    }
...
window.onload = function () {
    ...
    window_div.append(createCoin());
    window_div.append(createRightDiv());
    window_div.append(createMap());
